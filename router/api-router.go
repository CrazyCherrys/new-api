...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/creative-space/assets", controller.GetCreativeSpaceAssets)
		apiRouter.GET("/creative-space/assets/:id", controller.GetCreativeSpaceAssetDetail)
		...
		imageGenRoute.Use(middleware.UserAuth())
		{
			...
			imageGenRoute.POST("/assets/:id/creative-submission", controller.SubmitImageGenerationAssetToCreativeSpace)
			imageGenRoute.GET("/creative-submissions", middleware.AdminAuth(), controller.GetImageCreativeSubmissions)
			imageGenRoute.PATCH("/creative-submissions/:id/review", middleware.AdminAuth(), controller.ReviewImageCreativeSubmission)
