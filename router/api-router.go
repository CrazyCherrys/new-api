...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/inspiration/assets", controller.GetInspirationAssets)
		apiRouter.GET("/inspiration/assets/:id", controller.GetInspirationAssetDetail)
		apiRouter.GET("/creative-space/assets", controller.GetInspirationAssets)
		apiRouter.GET("/creative-space/assets/:id", controller.GetInspirationAssetDetail)
		...
		imageGenRoute.Use(middleware.UserAuth())
		{
			...
			imageGenRoute.POST("/assets/:id/inspiration-submission", controller.SubmitImageGenerationAssetToInspiration)
			imageGenRoute.POST("/assets/:id/creative-submission", controller.SubmitImageGenerationAssetToInspiration)
			imageGenRoute.GET("/inspiration-submissions", middleware.AdminAuth(), controller.GetImageInspirationSubmissions)
			imageGenRoute.GET("/creative-submissions", middleware.AdminAuth(), controller.GetImageInspirationSubmissions)
			imageGenRoute.PATCH("/inspiration-submissions/:id/review", middleware.AdminAuth(), controller.ReviewImageInspirationSubmission)
			imageGenRoute.PATCH("/creative-submissions/:id/review", middleware.AdminAuth(), controller.ReviewImageInspirationSubmission)
			imageGenRoute.DELETE("/inspiration-submissions/:id", middleware.AdminAuth(), controller.DeleteImageInspirationSubmission)
